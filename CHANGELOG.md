...
- added 'useJsonFieldNames' parameter to StructToMapFieldsWithWriteXS
...
- ConvertMapFieldsToTypedSlices as a second-level convenience function to convert map fields to typed slices.
